...
### v1.4.0 (2025-09-23 15:24:00) - 数据库修复版本 🛠️
**Git Commit:** `0dc32ce`
**主要修复：** 解决个人信息保存功能的数据库触发器错误

**核心修复：**
- ✅ 删除有问题的数据库触发器 `trigger_auto_self_schedule_permission`
- ✅ 解决 "relation 'self_schedule_permissions' does not exist" 错误
- ✅ 个人信息保存功能在Vercel和Netlify环境完全恢复正常
- ✅ 清理AXCF202505测试数据，学员可重新自主设定打卡时间
...
**新增功能：**
- 🧪 专用测试API `/api/test/profile-save-test`
- 🧪 可视化测试页面 `/test/profile-save-test`
- 📊 数据库状态检查工具
