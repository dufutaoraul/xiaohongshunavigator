            ...
            <div className="space-y-4">
              {results.map((note, index) => (
                <div 
                  ...
                  className="glass-effect rounded-xl p-6 hover:scale-[1.02] transition-all duration-300 floating-card cursor-pointer group"
                  onClick={() => {
                    if (note.url) {
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <h3 className="font-semibold text-white text-lg leading-relaxed group-hover:text-pink-300 transition-colors flex-1 pr-4">
                      {note.title || '无标题'}
                    </h3>
                    <div className="flex items-center gap-2 text-sm text-pink-300 opacity-70 group-hover:opacity-100 transition-opacity">
                      <span className="breathing-glow">🔗</span>
                      <span className="whitespace-nowrap">查看原文</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-3 pt-3 border-t border-white/5">
                    ...
                    {/* 悬停提示 */}
                    <div className="opacity-0 group-hover:opacity-100 transition-opacity text-xs text-pink-300">
                      点击卡片查看小红书原文 →
                    </div>
                  </div>
                </div>
